...
export const about = {
  ...
  paragraphs: [
    ...
    "I'm a Data Science and Statistics student at the University of Michigan (Class of 2027). Near-term I'm looking for AI product, research, and ML / LLM / agentic engineering roles.",
  ],
  aside: {
    label: "At a glance",
    items: [
